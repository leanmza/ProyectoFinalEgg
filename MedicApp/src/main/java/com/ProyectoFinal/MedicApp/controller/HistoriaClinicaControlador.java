...
public class HistoriaClinicaControlador {
    ...
    public String listar(ModelMap model) {
        List<HistoriaClinica> historiasClinicas = historiaClinicaService.listar() ;
        model.addAttribute("historiasClinicas", historiasClinicas);
        return "lista_historia_clinica.html";
    }
 
    //   /historiaClinica/form_historia_clinica
    @Transactional
...
//          Profesional profesional = (Profesional) session.getAttribute("profesionalSession");
          String idProfesional = session.getId();
//        System.out.println("Profesional: " + profesional.toString());
        ...
        try {
            ...
            historiaClinicaService.crearHistoriaClinica(dni, fechaConsulta, idProfesional, diagnostico);
